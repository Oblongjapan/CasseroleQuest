...
### Counting Ingredients Correctly
The system counts **base ingredients**, not card count. A combined card like "Chicken+Rice" counts as 2 base ingredients:
- `"Chicken"` = 1 base ingredient
- `"Chicken+Rice"` = 2 base ingredients (1 "+" sign)
- `"Chicken+Rice+Steak"` = 3 base ingredients (2 "+" signs)

This means:
- Combining `["Chicken", "Rice"]` = 2 base ingredients ✅ Allowed in Tier 1
- Combining `["Chicken+Rice", "Steak"]` = 3 base ingredients ❌ Blocked until Tier 2
- Combining `["Chicken", "Rice", "Steak"]` = 3 base ingredients ❌ Blocked until Tier 2

### Duplicate Prevention
You cannot select the same ingredient twice. Each selected ingredient must be unique by name.
