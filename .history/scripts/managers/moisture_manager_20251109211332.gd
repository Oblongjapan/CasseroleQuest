...
func setup(ingredient_1: IngredientModel, ingredient_2: IngredientModel, difficulty: float = 1.0, inventory: InventoryManager = null) -> void:
	...
	var combined_heat_resist = min(ingredient_1.heat_resistance, ingredient_2.heat_resistance)
	var combined_volatility = max(ingredient_1.volatility, ingredient_2.volatility)
	...
	var base_drain_per_round = 1.0  # This scales with difficulty (rounds passed)
