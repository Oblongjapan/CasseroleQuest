...
func setup(ingredient_1, ingredient_2 = null, difficulty = 1.0, inventory = null) -> void:
	...
	var combined_heat_resist = ingredient_1.heat_resistance
	if ingredient_2 != null:
		combined_heat_resist = min(ingredient_1.heat_resistance, ingredient_2.heat_resistance)

	var combined_volatility = ingredient_1.volatility
	if ingredient_2 != null:
		combined_volatility = max(ingredient_1.volatility, ingredient_2.volatility)
