...
enum MalfunctionType {
	...
	MACROWAVE      ## 1 second per card in hand
}
...
## Whether this uses timer-per-card logic (Macrowave)
@export var timer_per_card: bool = false
...
func _init(
	...
	timer_per_card = p_timer_per_card
