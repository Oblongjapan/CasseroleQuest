...
func _on_recipe_book_pressed() -> void:
	...
	print("[MainMenu] Recipe book UI visible before open: ", str(recipe_book_ui.visible) if recipe_book_ui else "N/A")
	recipe_book_ui.open_book()
	print("[MainMenu] Recipe book UI visible after open: ", str(recipe_book_ui.visible) if recipe_book_ui else "N/A")
