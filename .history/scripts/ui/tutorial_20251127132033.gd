...
@onready var screenshot: TextureRect = $MarginContainer/VBoxContainer/ScrollContainer/PageContainer/PageContent/Screenshot
@onready var description_label: Label = $MarginContainer/VBoxContainer/ScrollContainer/PageContainer/PageContent/DescriptionLabel
...
func _ready():
	# Initialize tutorial pages (Main menu page removed)
	pages = [
		{
