...
@onready var hand_container: HBoxContainer = get_node_or_null("VBoxContainer/HandContainer") as HBoxContainer
@onready var title_label: Label = get_node_or_null("VBoxContainer/TopPanel/VBoxContainer/TitleLabel") as Label
@onready var info_label: Label = get_node_or_null("VBoxContainer/TopPanel/VBoxContainer/InfoLabel") as Label
