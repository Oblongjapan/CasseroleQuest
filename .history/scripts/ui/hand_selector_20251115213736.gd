...
## Show hand selection with 5 cards
func show_hand_selection(fridge: FridgeManager, game_state_mgr: GameStateManager = null) -> void:
	...
	# Draw cards to fill hand up to 5 (keep existing cards from previous round)
	var cards_to_draw = 5 - hand_ingredients.size()
	if cards_to_draw > 0:
