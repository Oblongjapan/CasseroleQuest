...
@onready var page_label: Label = $VBox/TopBar/PageLabel
@onready var prev_button: Button = $VBox/TopBar/PrevButton
@onready var next_button: Button = $VBox/TopBar/NextButton
...
func _ready():
	...
	style_box.bg_color = Color(0.08, 0.05, 0.15, 0.98)
	style_box.border_width_left = 4
	style_box.border_width_right = 4
	style_box.border_width_top = 4
	style_box.border_width_bottom = 4
	style_box.border_color = Color(0.5, 0.4, 0.8, 1.0)
