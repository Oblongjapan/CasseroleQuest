...
func _create_free_sample_panel(item: Dictionary) -> Control:
	...
	food_sprite.custom_minimum_size = Vector2(100, 100)  # ADJUST FOOD SPRITE SIZE HERE
	...
	take_button.custom_minimum_size = Vector2(100, 40)  # ADJUST BUTTON SIZE HERE
	take_button.position = Vector2(10, 130)  # ADJUST BUTTON POSITION HERE
