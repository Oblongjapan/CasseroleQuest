...
@onready var water_label: Label = $StatsContainer/WaterLabel
@onready var resist_label: Label = $StatsContainer/ResistLabel
@onready var volatility_label: Label = $StatsContainer/VolatilityLabel
