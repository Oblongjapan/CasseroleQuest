...
func get_recipe_name_for_ingredients(ingredient_names: Array[String]) -> String:
	...
	var recipe_names = {
		...
		"Asparagus|Bread|Broccoli|Lettuce": "Spring Green Sandwich",
		"Asparagus|Bread|Broccoli|Peas": "Premium Green Sub",
		"Asparagus|Bread|Broccoli|Potato": "Hearty Spring Sandwich",
		"Asparagus|Bread|Broccoli|Rice": "Spring Grain Wrap",
		"Asparagus|Bread|Carrot|Peas": "Garden Spring Sandwich",
		"Asparagus|Bread|Carrot|Potato": "Root Spring Sub",
		"Asparagus|Bread|Carrot|Rice": "Spring Carrot Wrap",
		"Asparagus|Bread|Chicken Breast|Peas": "Spring Chicken Green Sub",
		"Asparagus|Bread|Chicken Breast|Potato": "Hearty Spring Chicken Sub",
		"Asparagus|Bread|Chicken Breast|Rice": "Spring Chicken Rice Wrap",
		"Asparagus|Bread|Lettuce|Peas": "Light Spring Sub",
		"Asparagus|Bread|Lettuce|Potato": "Fresh Spring Comfort",
		"Asparagus|Bread|Lettuce|Rice": "Spring Fresh Grain",
		"Asparagus|Bread|Peas|Potato": "Green Spring Comfort",
		"Asparagus|Bread|Peas|Rice": "Spring Green Grain",
		"Asparagus|Bread|Potato|Rice": "Spring Carb Sandwich",
		"Asparagus|Bread|Salmon|Spinach": "Gourmet Spring Salmon Sub",
		"Asparagus|Bread|Steak|Spinach": "Gourmet Spring Steak Sub",
		"Asparagus|Bread|Tofu|Spinach": "Gourmet Spring Vegan Sub",
		...
		"Asparagus|Bread|Chicken Breast|Steak": "Spring Power Meat Sub",
		"Asparagus|Bread|Chicken Breast|Tofu": "Spring Protein Balance Sub",
		"Asparagus|Bread|Lettuce|Salmon": "Fresh Spring Salmon Wrap",
		"Asparagus|Bread|Lettuce|Steak": "Fresh Spring Steak Wrap",
		"Asparagus|Bread|Lettuce|Tofu": "Fresh Spring Vegan Wrap",
		"Asparagus|Bread|Peas|Salmon": "Spring Green Salmon Sub",
		"Asparagus|Bread|Peas|Steak": "Spring Green Steak Sub",
		"Asparagus|Bread|Peas|Tofu": "Spring Green Vegan Sub",
		"Asparagus|Bread|Potato|Salmon": "Hearty Spring Salmon",
		"Asparagus|Bread|Potato|Steak": "Hearty Spring Steak",
		"Asparagus|Bread|Potato|Tofu": "Hearty Spring Vegan",
		"Asparagus|Bread|Rice|Salmon": "Spring Salmon Grain Wrap",
		"Asparagus|Bread|Rice|Steak": "Spring Steak Grain Wrap",
		"Asparagus|Bread|Rice|Tofu": "Spring Vegan Grain Wrap",
		"Asparagus|Bread|Salmon|Steak": "Spring Premium Protein Sub",
		"Asparagus|Bread|Salmon|Tofu": "Spring Omega Balance Sub",
		"Asparagus|Bread|Steak|Tofu": "Spring Power Balance Sub",
