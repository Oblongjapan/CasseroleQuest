...
const TIER_0_INGREDIENTS = [
	...
	"Peas", "Bread", "Lettuce", "Spinach", "Asparagus", "Carrot", "Broccoli"
]
...
func get_recipe_name_for_ingredients(ingredient_names: Array[String]) -> String:
	...
	var recipe_names = {
		# 2 Ingredients - ALL 66 COMBINATIONS (12 ingredients)
		# Asparagus combinations (11)
		"Asparagus|Bread": "Asparagus Toast",
		"Asparagus|Broccoli": "Green Veggie Mix",
		"Asparagus|Carrot": "Veggie Duo",
		"Asparagus|Chicken Breast": "Chicken Asparagus",
		"Asparagus|Lettuce": "Asparagus Salad",
		"Asparagus|Peas": "Green Medley",
		"Asparagus|Potato": "Roasted Veggie Plate",
		"Asparagus|Rice": "Asparagus Rice",
		"Asparagus|Spinach": "Leafy Greens Mix",
		"Asparagus|Steak": "Steak with Asparagus",
		"Asparagus|Tofu": "Tofu Asparagus",
		
		# Bread combinations (10 remaining)
		...
		# Broccoli combinations (9 remaining)
		...
		# Carrot combinations (8 remaining)
		...
		"Carrot|Spinach": "Carrot Greens",
		"Carrot|Steak": "Steak & Carrots",
		"Carrot|Tofu": "Tofu Carrot Bowl",
		
		# Chicken Breast combinations (7 remaining)
		...
		"Chicken Breast|Steak": "Meat Combo",
		"Chicken Breast|Tofu": "Protein Mix",
		
		# Lettuce combinations (6 remaining)
		...
		# Peas combinations (5 remaining)
		"Peas|Potato": "Peas & Potatoes",
		"Peas|Rice": "Peas & Rice",
		"Peas|Spinach": "Green Duo",
		"Peas|Steak": "Steak & Peas",
		"Peas|Tofu": "Tofu & Peas",
		
		# Potato combinations (4 remaining)
		"Potato|Rice": "Carb Combo",
		"Potato|Spinach": "Spinach Potato",
		"Potato|Steak": "Steak & Potatoes",
		"Potato|Tofu": "Tofu Potato Bowl",
		
		# Rice combinations (3 remaining)
		"Rice|Spinach": "Spinach Rice",
		"Rice|Steak": "Steak Rice Bowl",
		"Rice|Tofu": "Tofu Rice Bowl",
		
		# Spinach combinations (2 remaining)
		"Spinach|Steak": "Steak Florentine",
		"Spinach|Tofu": "Tofu Spinach",
		
		# Steak combinations (1 remaining)
		"Steak|Tofu": "Steak & Tofu",
