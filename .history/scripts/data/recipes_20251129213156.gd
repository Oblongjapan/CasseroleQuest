...
func get_recipe_name_for_ingredients(ingredient_names: Array[String]) -> String:
	...
	# Recipe name mappings - organized by tier and ingredient count
	var recipe_names = {
		# ===== TIER 1: 2 Ingredients - ONLY BASE INGREDIENTS =====
		...
		# ===== TIER 2: 3-4 Ingredients - BASE + PREMIUM =====
		...
		# ===== TIER 3: 5-6 Ingredients =====
		# (Too many combinations to list exhaustively - providing key examples)
