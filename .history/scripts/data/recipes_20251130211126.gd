...
func get_recipe_name_for_ingredients(ingredient_names: Array[String]) -> String:
	...
	var recipe_names = {
		...
		"Asparagus|Broccoli|Salmon|Spinach": "Omega Spring Power",
		...
		"Carrot|Potato|Rice|Spinach": "Root Grain Power",
		...
		"Chicken Breast|Potato|Rice|Spinach": "Protein Comfort Grain",
		"Lettuce|Peas|Potato|Spinach": "Fresh Green Comfort",
		"Lettuce|Peas|Rice|Spinach": "Light Green Grain",
		"Lettuce|Potato|Rice|Spinach": "Fresh Comfort Grain",
		"Peas|Potato|Rice|Spinach": "Green Grain Harmony",
