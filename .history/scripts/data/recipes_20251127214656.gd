...
const TIER_2_UNLOCK_THRESHOLD = 12  # 3+ ingredient recipes - REQUIRES 12 unique 2-ingredient recipes
const TIER_3_UNLOCK_THRESHOLD = 20  # Advanced recipes - after 20 total recipes
