...
const TIER_1_UNLOCK_THRESHOLD = 0  # Simple combos (2 ingredients) - unlocked at game start
const TIER_2_UNLOCK_THRESHOLD = 6  # Advanced combos (3 ingredients) - after 6 unique recipes
