...
func _check_map_progress() -> void:
	...
	if rounds_in_current_chunk >= 3:
		# Save last card from hand to persistent before going to shop
		print("[Main] 3-round chunk complete - saving last card to persistent")
		fridge_manager.save_last_card_to_persistent()
