...
func _on_round_completed(success: bool, final_moisture: float) -> void:
	...
	if is_malfunction_round and current_malfunction:
		...
		# After malfunction, go directly to next round (no shop)
		print("[Main] Malfunction complete - going to next round")
...
func _on_shop_closed() -> void:
	...
	print("[Main] Shop closed - returning to hand selector for round %d" % current_round_number)
	_show_hand_selector()
